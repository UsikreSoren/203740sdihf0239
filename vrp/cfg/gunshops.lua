...
cfg.gunshop_types = {
  ...
  ["tataviammountains1"] = {
    _config = {blipid=110,blipcolor=2},
  ...
  ["policeloadout"] = {
    _config = {blipid=110,blipcolor=1, permissions = {"police.loadshop"}},
    ["WEAPON_MARKSMANPISTOL"] = {"Marksman Pistol",1500,15,""},
    ["WEAPON_SNSPISTOL"] = {"Pistol",1500,15,""},
    ["WEAPON_GRENADE"] = {"Grenade",1500,15,""},
    ["WEAPON_SMOKEGRENADE"] = {"Smoke Grenade",1500,15,""},
    ["WEAPON_PETROLCAN"] = {"Petrol",1500,15,""},
	["WEAPON_SAWNOFFSHOTGUN"] = {"Saw Shotgun",1500,15,""},
    ["WEAPON_PUMPSHOTGUN"] = {"Pump Shotgun",1500,15,""},
    ["WEAPON_BULLPUPSHOTGUN"] = {"BullUp Shotgun",1500,15,""},
    ["WEAPON_HEAVYSHOTGUN"] = {"Heavy Shotgun",1500,15,""},
    ["WEAPON_ASSAULTSHOTGUN"] = {"Assault Shotgun",1500,15,""},
	["WEAPON_BULLPUPRIFLE"] = {"Bullpup Rifle",1500,15,""},
    ["WEAPON_ADVANCEDRIFLE"] = {"Carabine",1500,15,""},
    ["WEAPON_SPECIALCARBINE"] = {"Special Carabine",1500,15,""},
    ["WEAPON_MOLOTOV"] = {"Molotv",1500,15,""},
    ["WEAPON_FLARE"] = {"Flare",1500,15,""},
	["WEAPON_MARKSMANRIFLE"] = {"Marksman Rifle",1500,15,""},
    ["WEAPON_SNIPERRIFLE"] = {"Sniper Rifle",1500,15,""},
    ["WEAPON_HEAVYSNIPER"] = {"Heavy Rifle",1500,15,""},
    ["WEAPON_GUSENBERG"] = {"Gusenberg MG",1500,15,""},
    ["WEAPON_MG"] = {"MG",1500,15,""},
    ["WEAPON_COMBATMG"] = {"Combat MG",1500,15,""},
    ["WEAPON_COMPACTRIFLE"] = {"Mini SMG",1500,15,""},
    ["WEAPON_ASSAULTRIFLE"] = {"Assault Rifle",1500,15,""},
    ["WEAPON_CARBINERIFLE"] = {"Carabineri Rifle",1500,15,""},
	["WEAPON_MICROSMG"] = {"Mini SMG",1500,15,""},
    ["WEAPON_SMG"] = {"SMG",1500,15,""},
    ["WEAPON_ASSAULTSMG"] = {"Assault SMG",1500,15,""},
    ["WEAPON_COMBATPDW"] = {"Combat PDW",1500,15,""},
    ["WEAPON_MACHINEPISTOL"] = {"Machine Pistol",1500,15,""},
    ["WEAPON_NIGHTSTICK"] = {"Nighstick",1500,0,""},
    ["WEAPON_CROWBAR"] = {"Crowwbar",1500,15,""},
    ["WEAPON_GOLFCLUB"] = {"Golf club",1500,15,""},
    ["WEAPON_SWITCHBLADE"] = {"Blade",1500,15,""},
    ["WEAPON_MACHETE"] = {"Machete",1500,15,""},
	["WEAPON_VINTAGEPISTOL"] = {"Vintage Pistol",1500,15,""},
    ["WEAPON_PISTOL"] = {"Pistol",1500,15,""},
    ...
    ["WEAPON_APPISTOL"] = {"Ap Pistol",1500,15,""},
    ["WEAPON_DAGGER"] = {"Dagger",1500,15,""},
    ["WEAPON_HAMMER"] = {"Hammer",1500,15,""},
    ["WEAPON_HATCHET"] = {"Hatchet",1500,15,""}
  },
  ["bombsticky"] = {
    _config = {blipid=152,blipcolor=1},
   ["WEAPON_STICKYBOMB"] = {"Sticky bomb",1500,15,""} 
 }
}
...
cfg.gunshops = {
  ...
  {"policeloadout", 459.540649414063,-989.075439453125,24.9148712158203},
